...
async function request(url, options = {}, redirects = 0) {
  ...
  headers.set("user-agent", "ossd-course-portal-mpm2d-resource-localizer/1.0");
...
const textbookAbsPath = join(courseRoot, textbookPath);
mkdirSync(dirname(textbookAbsPath), { recursive: true });
copyFileSync(textbookSourcePath, textbookAbsPath);
const textbookBytes = statSync(textbookAbsPath).size;
manifest.texts = [
  {
...
const courseActivities = [
  { id: 8471, title: "MPM2D Course Outline", role: "course_outline", teacherUse: "course_setup" },
  { id: 8472, title: "Learning Log", role: "learning_log", teacherUse: "student_tracking_template" },
  { id: 8566, title: "Exam Submission Dropbox", role: "final_exam_submission", teacherUse: "assessment_preparation" },
  { id: 8567, title: "Culminating Assignment Dropbox", role: "culminating_submission", teacherUse: "assessment_preparation" },
];
...
const answerKeys = await buildActivityPage({
  ...
  teacherOnly: true,
  targetDir: activityTargetDir("assign", 8596, "Answer Keys"),
});
upsertByIdentity(manifest.teacherResources, answerKeys);

manifest.courseDownloads = manifest.courseDownloads.filter((item) => item.path !== "plans/course/MPM2D_Course_Outline.docx");

const unitActivities = {
  1: {
    evaluations: [
      ["Unit 1 Assignment (AOL)", "assign", 8476],
      ["Unit 1 - Test 1 (AOL)", "quiz", 8477],
      ["Unit 1 - Test 2 (AOL)", "quiz", 8478],
    ],
    reflectionAndLogs: [
      ["Unit 1 - KWL Dropbox", "assign", 8494, "kwl_dropbox"],
      ["Unit 1 - Reflection Summary Dropbox", "assign", 8495, "reflection_dropbox"],
    ],
    lessonDropboxes: [8480, 8482, 8484, 8486, 8488, 8490, 8492].map((id, index) => [`Unit 1 - Lesson ${index + 1}`, "assign", id]),
    answerPages: [8481, 8483, 8485, 8487, 8489, 8491, 8493].map((id, index) => [`Unit 1 - Lesson ${index + 1} Answer`, "page", id]),
  },
  2: {
    evaluations: [
      ["Unit 2 Assignment (AOL)", "assign", 8499],
      ["Unit 2 - Test 1 (AOL)", "quiz", 8500],
      ["Unit 2 - Test 2 (AOL)", "quiz", 8501],
    ],
    reflectionAndLogs: [
      ["Unit 2 - KWL Dropbox", "assign", 8517, "kwl_dropbox"],
      ["Unit 2 - Reflection Summary Dropbox", "assign", 8518, "reflection_dropbox"],
    ],
    lessonDropboxes: [8503, 8505, 8507, 8509, 8511, 8513, 8515].map((id, index) => [`Unit 2 - Lesson ${index + 1}`, "assign", id]),
    answerPages: [8504, 8506, 8508, 8510, 8512, 8514, 8516].map((id, index) => [`Unit 2 - Lesson ${index + 1} Answer`, "page", id]),
  },
  3: {
    evaluations: [
      ["Unit 3 Assignment (AOL)", "assign", 8522],
      ["Unit 3 - Test 1 (AOL)", "quiz", 8523],
      ["Unit 3 - Test 2 (AOL)", "quiz", 8524],
    ],
    reflectionAndLogs: [
      ["Unit 3 - KWL Dropbox", "assign", 8542, "kwl_dropbox"],
      ["Unit 3 - Reflection Summary Dropbox", "assign", 8543, "reflection_dropbox"],
    ],
    lessonDropboxes: [8526, 8528, 8530, 8532, 8534, 8536, 8538, 8540].map((id, index) => [`Unit 3 - Lesson ${index + 1}`, "assign", id]),
    answerPages: [8527, 8529, 8531, 8533, 8535, 8537, 8539, 8541].map((id, index) => [`Unit 3 - Lesson ${index + 1} Answer`, "page", id]),
  },
  4: {
    evaluations: [
      ["Unit 4 Assignment (AOL)", "assign", 8547],
      ["Unit 4 - Test 1 (AOL)", "quiz", 8548],
      ["Unit 4 - Test 2 (AOL)", "quiz", 8549],
    ],
    reflectionAndLogs: [
      ["Unit 4 - KWL Dropbox", "assign", 8564, "kwl_dropbox"],
      ["Unit 4 - Reflection Summary Dropbox", "assign", 8565, "reflection_dropbox"],
    ],
    lessonDropboxes: [
      ["Unit 4 - Lesson 1", "assign", 8551],
      ["Unit 4 - Lesson 2", "assign", 8553],
      ["Unit 4 - Lesson 3", "assign", 8555],
      ["Unit 4 - Lesson 4", "assign", 8557],
      ["Unit 4 - Lesson 5", "assign", 8559],
      ["Unit 4 - Lesson 6", "assign", 8561],
      ["Unit 4 - Lesson 7", "assign", 8562],
    ],
    answerPages: [
      ["Unit 4 - Lesson 1 Answer", "page", 8552],
      ["Unit 4 - Lesson 2 Answer", "page", 8554],
      ["Unit 4 - Lesson 3 Answer", "page", 8556],
      ["Unit 4 - Lesson 4 Answer", "page", 8558],
      ["Unit 4 - Lesson 5 Answer", "page", 8560],
      ["Unit 4 - Lesson 7 Answer", "page", 8563],
    ],
  },
};
...
manifest.sourceAudit.courseResourceExpectedActivities = {
  courseOutline: 8471,
  learningLog: 8472,
  finalExamSubmission: 8566,
  culminatingSubmission: 8567,
  answerKeys: 8596,
};
