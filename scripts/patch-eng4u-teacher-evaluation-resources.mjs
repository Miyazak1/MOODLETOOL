...
async function request(url, options = {}, redirects = 0) {
  ...
  headers.set("user-agent", "ossd-course-portal-eng4u-teacher-evaluation-patch/1.0");
...
async function buildCourseSectionPage({ sectionNumber, sectionId, title, role, targetDir }) {
  ...
  const source = `https://www.esunnybrook.com/course/view.php?id=72&section=${sectionNumber}`;
...
const courseLevel = [
  activityRecord(7533, "ENG4U Course Outline", "course_outline", { teacherUse: "course_setup" }),
  activityRecord(7534, "Learning Log", "learning_log", { teacherUse: "student_tracking_template" }),
  activityRecord(7621, "Exam Submission Dropbox", "final_exam_submission", { teacherUse: "final_evaluation" }),
  activityRecord(7620, "Culminating Submission Dropbox", "culminating_submission", { teacherUse: "final_evaluation" }),
  activityRecord(7648, "Answer Keys", "answer_keys", { teacherUse: "teacher_packet", teacherOnly: true }),
];
for (const item of courseLevel) upsertByKey(manifest.courseDownloads, item);

const unitEvaluations = {
  1: [
    activityRecord(7538, "Unit 1 - Assignment (Part 1 - Essay)", "aol_assignment"),
    activityRecord(7539, "Unit 1 - Assignment (Part 2 - Peer Review and Editing)", "aol_peer_review_forum", { mod: "forum" }),
    activityRecord(7540, "Unit 1 - Test", "aol_quiz", { mod: "quiz" }),
  ],
  2: [
    activityRecord(7563, "Unit 2 - Assignment 1 (AOL)", "aol_assignment"),
    activityRecord(7564, "Unit 2 - Assignment 2 (AOL)", "aol_assignment"),
    activityRecord(7565, "Unit 2 - Test (AOL)", "aol_quiz", { mod: "quiz" }),
  ],
  3: [
    activityRecord(7585, "Unit 3 - Assignment 1 (AOL)", "aol_assignment"),
    activityRecord(7586, "Unit 3 - Assignment 2 (AOL)", "aol_assignment"),
    activityRecord(7587, "Unit 3 - Test", "aol_quiz", { mod: "quiz" }),
  ],
  4: [
    activityRecord(7605, "Unit 4 - Assignment", "aol_assignment"),
    activityRecord(7606, "Unit 4 - Assignment 2", "aol_quiz", { mod: "quiz" }),
  ],
};

const reflectionAndLogs = {
  1: [activityRecord(7558, "Unit 1 - KWL Dropbox", "kwl_dropbox"), activityRecord(7559, "Unit 1 - Reflection Summary Dropbox", "reflection_dropbox")],
  2: [activityRecord(7580, "Unit 2 - KWL Dropbox", "kwl_dropbox"), activityRecord(7581, "Unit 2 - Reflection Summary Dropbox", "reflection_dropbox")],
  3: [activityRecord(7600, "Unit 3 - KWL Dropbox", "kwl_dropbox"), activityRecord(7601, "Unit 3 - Reflection Summary Dropbox", "reflection_dropbox")],
  4: [activityRecord(7618, "Unit 4 - KWL Dropbox", "kwl_dropbox"), activityRecord(7619, "Unit 4 - Reflection Summary Dropbox", "reflection_dropbox")],
};
...
manifest.sourceAudit.eng4uTeacherEvaluationPatch = {
  ...
  notes: "Teacher-facing ENG4U course overview, final/culminating, teacher packet, AOL, quiz rubrics, KWL and reflection activities were added as localizable teacher preparation resources. Student formative-only activities are excluded.",
};
...
console.log(JSON.stringify(manifest.sourceAudit.eng4uTeacherEvaluationPatch, null, 2));
