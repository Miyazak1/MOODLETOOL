...
const unitPlanPaths = {
  1: "plans/source/UNIT PLANS/Unit 1 Plan.docx",
  2: "plans/source/UNIT PLANS/Unit 2 Plan.docx",
  3: "plans/source/UNIT PLANS/Unit 3 Plan.docx",
  4: "plans/source/UNIT PLANS/Unit 4 Plan.docx",
  5: "plans/source/UNIT PLANS/Unit 5 Plan.docx",
};

const lessonPlanDirs = {
  1: "Unit 1 Dynamics",
  2: "Unit 2 Energy & Momentum",
  3: "Unit 3 Gravitational, Electric & Magnetic Fields",
  4: "Unit 4 The Wave Nature of Light",
  5: "Unit 5 Revolutions in Modern Physics",
};
...
manifest.sourceAudit = {
  ...(manifest.sourceAudit || {}),
  moodleCourseId: 84,
  coursePage: "https://www.esunnybrook.com/course/view.php?id=84",
