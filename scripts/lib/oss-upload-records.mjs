...
function indexItem(record) {
  return {
    ...
    localContentStatus: record.localContentStatus || "",
    hasPlayableMedia: record.hasPlayableMedia === true,
    latestUploadId: record.latestUploadId || "",
    latestImportSummary: record.latestImportSummary || null,
    importMode: record.importMode || "",
    importedAt: record.importedAt || null,
    ossOnly: record.ossOnly === true,
    targetPrefix: record.targetPrefix || "",
    extractedAt: record.extractedAt || null,
    extractedBy: record.extractedBy || "",
    extractReport: record.extractReport || "",
    ingestMessage: record.ingestMessage || "",
    jobId: record.jobId || "",
